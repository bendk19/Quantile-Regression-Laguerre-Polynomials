...
## as which.max and which.min but with another treatment for ties
...
##Transform (univariate) completely observed obs. in interval censored obs. 
##Use better transform.IC.extrval.V3
